...
impl FromBytes for AudioTrack {
    fn from_bytes(bytes: &[u8]) -> Result<Self, LoadError> {
        ...
        cursor
            ...
            .with_ctx(ParseContext::AudioTrack)?;
        ...
        while region_cursor.position() < region_len as u64 {
            ...
            let region_data_bytes =
                safe_read(&mut region_cursor, region_len).with_ctx(ParseContext::AudioTrack)?;
            let region = AudioRegion::from_bytes(&region_data_bytes)?;

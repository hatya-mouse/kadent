...
pub(super) fn draw_waveform_in(
    ...
    let Some(waveform_lod) = ui_state
        .timeline_state
        .waveforms
    ...
    for pixel in start_pixel..end_pixel {
        let pixel_start_frame = region.data_offset + (pixel as f32 * src_frames_per_pixel) as usize;
        let pixel_end_frame =
